...
const Answered = () => {
  ...
  useEffect(() => {
    if (answeredState.length) {
      ...
      setTypesLength([
        { name: "Todas", amount: answeredState.length },
        ...separeteByType(answeredState, "resultTypeFormated"),
      ]);
      setCurrentType(`Todas (${answeredState.length})`);
    }
  }, [answeredState]);
      ...
      {!answeredState.length ? (
        ...
        >
          ...
          <Typography color="secondary" pt={5}>
            Aqui você verá seu histórico de respostas
          </Typography>
        </Box>
      ) : (
        <Box hidden={viewMode}>
          ...
          <Box pt={0.5} pb={2}>
            <Typography sx={{ color: "#6b7280" }}>
              Clique sobre a pergunta para ver
            </Typography>
          </Box>
          <List
            sx={{
              ...
              >
                <Box width="100%" display="flex" flexDirection="column">
                  ...
                  <Box>
                    ...
                    >
                      {truncate(`Sua resposta: ${answ.answers[answ.correct]}`)}
                    </Typography>
                  </Box>
                  <Box>
